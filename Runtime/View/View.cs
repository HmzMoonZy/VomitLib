...
namespace Twenty2.VomitLib.View
{
    ...
    public static class View
    {
        ...
        private static async UniTask<ViewLogic> __OpenAsync(string viewId, ViewParameterBase param = null)
        {
            ...
            _hiddenViewMap.Remove(viewId, out logic);
